...
<div class="splitted-content-mini navbar-dark bg-dark h-100 py-3">
  <a class="navbar-brand d-flex justify-content-center mb-3" href="{{ route('dashboard.home') }}">
    @isset($perusahaan->logo)
      <img class="navbar-brand-logo-short" src="{{ $perusahaan?->logo }}" alt="Logo">
    @else
      <img class="navbar-brand-logo-short" src="{{ asset('assets/dashboard/images/image_empty.jpg') }}" alt="Logo">
    @endisset
  </a>
    ...
    <li class="nav-item">
      <div class="dropdown dropright">
        <button type="button" class="btn btn-ghost-secondary btn-icon rounded-circle" id="selectThemeDropdown"
          data-bs-toggle="dropdown" aria-expanded="false" data-bs-dropdown-animation></button>

        <div class="dropdown-menu navbar-dropdown-menu navbar-dropdown-menu-borderless"
          aria-labelledby="selectThemeDropdown">
          <a class="dropdown-item" href="#" data-icon="bi-moon-stars" data-value="auto">
            <i class="bi-moon-stars me-2"></i>
            <span class="text-truncate" title="Bawaan Sistem">Bawaan Sistem</span>
          </a>
