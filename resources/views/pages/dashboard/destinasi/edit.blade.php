<x-layout.dashboard title="Edit Destinasi">
    ...
    <form action="{{ route('dashboard.destinasi.update', ['destinasi' => $destinasi->id]) }}" method="post"
                                    ...
                                    <label for="aktif"
                                        ...
                                        <span class="form-check">
                                            <input type="radio" name="status" id="aktif" value="1"
                                                class="form-check-input" @checked(old('status', $destinasi->aktif) == '1')>
                                    ...
                                    <label for="tidakAktif"
                                        ...
                                        <span class="form-check">
                                            <input type="radio" name="status" id="tidakAktif" value="0"
                                                class="form-check-input" @checked(old('status', $destinasi->aktif) == '0')>
