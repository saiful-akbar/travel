<x-layout.dashboard title="Edit">
    ...
    <form
        id="formEditArtikel"
        action="{{ route('dashboard.artikel.update', ['artikel' => $artikel->id])}}"
        method="POST"
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-lg-9 col-12">
                                ...
                                >
                                    ...
                                    @foreach ($kategori as $kategoriItem)
                                        <option value="{{ $kategoriItem->id}}" @selected(old('kategori', $artikel->kategori_id) == $kategoriItem->id)>
                                            {{ $kategoriItem->nama}}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-9 col-12">
                                ...
                                <span class="form-text">Biarkan gambar tetap kosong jika tidak ingin merubahnya</span>
                                    ...
                                    >
                                        <span class="form-check">
                                            <input
                                                ...
                                                id="ya"
                                                value="1"
                                                @checked(old('publikasikan', $artikel->publikasikan) == '1')
                                                @class([
                                                    "form-check-input",
                                                    "is-invalid" => $errors->has('publikasikan'),
                                                ])
                                    ...
                                    >
                                        <span class="form-check">
                                            <input
                                                ...
                                                id="tidak"
                                                value="0"
                                                @checked(old('publikasikan', $artikel->publikasikan) == '0')
                                                @class([
                                                    "form-check-input",
                                                    "is-invalid" => $errors->has('publikasikan'),
                                                ])
    ...
    <x-slot:script>
        <script>
            ...
            document.getElementById('formEditArtikel').onsubmit = function() {
        ...
        @if (old('konten', $artikel->konten))
            <script>
                quill.pasteHTML(`{!! old('konten', $artikel->konten) !!}`);
            </script>
        @endif
    </x-slot:script>
</x-layout.dashboard>